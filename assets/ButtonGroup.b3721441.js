import{e as a,v as d,g as e,t as o,f as s,d as f,u as b,bc as p,E as g,bd as h,ar as m,h as $}from"./index.2814604b.js";const t="0!important",u="-1px!important";function i(r){return o(r+"-type",[e("& +",[a("button",{},[o(r+"-type",[s("border",{borderLeftWidth:t}),s("state-border",{left:u})])])])])}function n(r){return o(r+"-type",[e("& +",[a("button",[o(r+"-type",[s("border",{borderTopWidth:t}),s("state-border",{top:u})])])])])}var v=a("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
