import{F as J}from"./avatar-64db8248.js";import{d as T,r as k,g as R,E as W,ad as D,t as I,h as g,k as y,af as K,a as z,ag as j,b as F,j as ee,ab as te,v as ne,ah as le,ai as Y,e as oe,u as X,D as ae,aj as se,i as re,ak as ie,al as ue,am as de,an as ce,ao as fe,ap as me,aq as _e,G as Z,H as L,P as a,R as e,U,S as P,a3 as he,F as H,I as s,ar as M,T as t,a8 as be,Q as l,Z as pe,V as E,as as ve,W as ge}from"./index-b648a77e.js";import{N as ye}from"./Progress-d0b0c9a7.js";import{N as we}from"./Table-9cd5a7f8.js";import{_ as xe}from"./P5.vue_vue_type_script_setup_true_lang-3f48f38b.js";import{g as Ne}from"./attribute-2ee9e579.js";import{N as $e}from"./headers-120964e5.js";import{a as Ee}from"./Image-4ee566dc.js";import{N as Fe}from"./Alert-36e8bd55.js";import{N as S}from"./li-cd50ff30.js";import{N as $}from"./blockquote-d012094b.js";import{N as ze}from"./Thing-84213150.js";import{N as A}from"./Divider-534a18ce.js";import{N as ke}from"./Scrollbar-ac81dcd5.js";import{b as V}from"./route-block-83d24a4e.js";import"./format-length-c9d165c6.js";import"./utils-fe1df518.js";import"./use-locale-6ac5a43a.js";import"./Tooltip-a8d51540.js";import"./cssr-5ca18ccd.js";import"./on-fonts-ready-6f4d157d.js";import"./use-merged-state-716bc3ea.js";import"./use-compitable-9c2cf601.js";const q=T({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(o){const _=k(null),c=k(o.value),u=k(o.value),r=k("up"),n=k(!1),f=R(()=>n.value?`${o.clsPrefix}-base-slot-machine-current-number--${r.value}-scroll`:null),b=R(()=>n.value?`${o.clsPrefix}-base-slot-machine-old-number--${r.value}-scroll`:null);W(I(o,"value"),(d,p)=>{c.value=p,u.value=d,D(h)});function h(){const d=o.newOriginalNumber,p=o.oldOriginalNumber;p===void 0||d===void 0||(d>p?v("up"):p>d&&v("down"))}function v(d){r.value=d,n.value=!1,D(()=>{var p;(p=_.value)===null||p===void 0||p.offsetWidth,n.value=!0})}return()=>{const{clsPrefix:d}=o;return g("span",{ref:_,class:`${d}-base-slot-machine-number`},c.value!==null?g("span",{class:[`${d}-base-slot-machine-old-number ${d}-base-slot-machine-old-number--top`,b.value]},c.value):null,g("span",{class:[`${d}-base-slot-machine-current-number`,f.value]},g("span",{ref:"numberWrapper",class:[`${d}-base-slot-machine-current-number__inner`,typeof o.value!="number"&&`${d}-base-slot-machine-current-number__inner--not-number`]},u.value)),c.value!==null?g("span",{class:[`${d}-base-slot-machine-old-number ${d}-base-slot-machine-old-number--bottom`,b.value]},c.value):null)}}}),{cubicBezierEaseOut:B}=K;function Se({duration:o=".2s"}={}){return[y("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${o} ${B},
 max-width ${o} ${B},
 transform ${o} ${B}
