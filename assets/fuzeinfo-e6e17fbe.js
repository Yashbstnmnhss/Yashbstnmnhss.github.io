import{F as J}from"./avatar-64db8248.js";import{d as T,r as k,g as R,E as W,ak as D,t as I,h as g,k as y,am as K,a as z,an as j,b as F,j as ee,ai as te,v as ne,ad as le,ao as Y,e as oe,u as X,D as ae,ap as se,i as re,ae as ie,aq as ue,ar as de,as as ce,at as fe,au as me,av as _e,G as Z,H as L,P as a,R as e,U,S as P,a3 as he,F as H,I as s,aw as M,T as t,a8 as be,Q as l,Z as pe,V as E,ax as ve,W as ge}from"./index-8198a965.js";import{N as ye}from"./Progress-63835ec6.js";import{N as we}from"./Table-bd909612.js";import{_ as xe}from"./P5.vue_vue_type_script_setup_true_lang-10c62737.js";import{g as Ne}from"./attribute-2ee9e579.js";import{N as $e}from"./headers-6317a2a1.js";import{a as Ee}from"./Image-ff10675e.js";import{N as Fe}from"./Alert-d89b0eb8.js";import{N as S}from"./li-f04280d4.js";import{N as $}from"./blockquote-043bcc2c.js";import{N as ze}from"./Thing-bf75a22f.js";import{N as A}from"./Divider-b3d9ce93.js";import{N as ke}from"./Scrollbar-357ee402.js";import{b as V}from"./route-block-83d24a4e.js";import"./format-length-c9d165c6.js";import"./utils-b7af5a8b.js";import"./use-locale-34e283f3.js";import"./kebabCase-7d6e3fd4.js";import"./Tooltip-18f18b57.js";import"./cssr-dea1d612.js";import"./on-fonts-ready-90ce3e21.js";import"./use-merged-state-9858bc20.js";import"./use-compitable-76448248.js";const q=T({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(o){const _=k(null),c=k(o.value),u=k(o.value),r=k("up"),n=k(!1),f=R(()=>n.value?`${o.clsPrefix}-base-slot-machine-current-number--${r.value}-scroll`:null),b=R(()=>n.value?`${o.clsPrefix}-base-slot-machine-old-number--${r.value}-scroll`:null);W(I(o,"value"),(d,p)=>{c.value=p,u.value=d,D(h)});function h(){const d=o.newOriginalNumber,p=o.oldOriginalNumber;p===void 0||d===void 0||(d>p?v("up"):p>d&&v("down"))}function v(d){r.value=d,n.value=!1,D(()=>{var p;(p=_.value)===null||p===void 0||p.offsetWidth,n.value=!0})}return()=>{const{clsPrefix:d}=o;return g("span",{ref:_,class:`${d}-base-slot-machine-number`},c.value!==null?g("span",{class:[`${d}-base-slot-machine-old-number ${d}-base-slot-machine-old-number--top`,b.value]},c.value):null,g("span",{class:[`${d}-base-slot-machine-current-number`,f.value]},g("span",{ref:"numberWrapper",class:[`${d}-base-slot-machine-current-number__inner`,typeof o.value!="number"&&`${d}-base-slot-machine-current-number__inner--not-number`]},u.value)),c.value!==null?g("span",{class:[`${d}-base-slot-machine-old-number ${d}-base-slot-machine-old-number--bottom`,b.value]},c.value):null)}}}),{cubicBezierEaseOut:B}=K;function Se({duration:o=".2s"}={}){return[y("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${o} ${B},
 max-width ${o} ${B},
 transform ${o} ${B}
