...
`,[oe(">",[z("clear",`
 ...
 opacity: 0;
 `)]),["warning","error"].map(e=>Z(`${e}-status`,[z("state-border",`border: var(--n-border-${e});`),Ve("disabled",[oe("&:hover",[z("state-border",`
...
`,[z("input, textarea",`
 ...
 `),oe("&:-webkit-autofill ~",[z("placeholder","display: none;")])]),Z("round",[Ve("textarea","border-radius: calc(var(--n-height) / 2);")]),z("placeholder",`
 pointer-events: none;
 position: absolute;
 left: 0;
 right: 0;
 ...
 width: 100%;
 display: inline-block;
 `)]),Z("textarea",[z("placeholder","overflow: visible;")]),Ve("autosize","width: 100%;"),Z("autosize",[z("textarea-el, input-el",`
 position: absolute;
 top: 0;
 left: 0;
 height: 100%;
 ...
 `),["warning","error"].map(e=>Z(`${e}-status`,[Ve("disabled",[k("base-loading",`
...
`,[k("pagination-prefix",`
 ...
 `)]),Ve("disabled",[Z("hover",dn,un),oe("&:hover",dn,un),oe("&:active",`
