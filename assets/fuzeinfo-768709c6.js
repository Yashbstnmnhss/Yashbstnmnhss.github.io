import{V as j}from"./venti-4f5f7960.js";import{S as ee}from"./shout-3ece43c9.js";import{F as te}from"./avatar-64db8248.js";import{a as I,r as B,e as C,ah as Q,aF as M,a5 as P,h as g,Q as y,bd as ne,I as k,be as le,T as z,J as oe,az as ae,a9 as se,bf as re,a_ as V,u as ie,b as G,s as ue,c as de,K as ce,a$ as fe,aD as me,bg as _e,bh as he,bi as be,j as pe,bj as ve,D as A,w as L,x as l,F as e,H as Z,Z as Y,bk as ge,$ as J,y as a,bl as q,G as t,b2 as ye,E as n,B as we,at as xe,aw as Ne,N as F}from"./index-fe2ea4cb.js";import{N as $e}from"./Table-5424b697.js";import{N as Ee}from"./Progress-33632821.js";import{_ as Fe}from"./P5.vue_vue_type_script_setup_true_lang-212644d5.js";import{C as ze}from"./ChatHistory-bc95c4d9.js";import{g as ke}from"./attribute-2ee9e579.js";import{N as R}from"./li-672d3419.js";import{N as Se}from"./text-b920c49c.js";import{N as Be}from"./headers-063f88e7.js";import{N as W}from"./Alert-79542b08.js";import{N as Re}from"./Image-51336758.js";import{N}from"./blockquote-11e73311.js";import{N as Ce}from"./Thing-2dded871.js";import{N as D}from"./Divider-a10c54bd.js";import{N as Ue}from"./Scrollbar-b78655f3.js";import{b as X}from"./route-block-83d24a4e.js";import"./format-length-c9d165c6.js";import"./Avatar-30c2cae6.js";import"./utils-3a0d0635.js";import"./Tag-25851762.js";import"./Space-510eabbf.js";import"./get-slot-1efb97e5.js";import"./_plugin-vue_export-helper-c27b6911.js";import"./use-compitable-d3ced092.js";import"./use-locale-dba060c0.js";import"./kebabCase-4051564a.js";import"./Tooltip-e64a2d70.js";import"./Popover-595a4cc8.js";import"./cssr-c566339e.js";import"./on-fonts-ready-29317161.js";import"./use-merged-state-65a5f827.js";import"./download-b096fc6b.js";const H=I({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(o){const h=B(null),m=B(o.value),p=B(o.value),d=B("up"),i=B(!1),w=C(()=>i.value?`${o.clsPrefix}-base-slot-machine-current-number--${d.value}-scroll`:null),s=C(()=>i.value?`${o.clsPrefix}-base-slot-machine-old-number--${d.value}-scroll`:null);Q(P(o,"value"),(r,c)=>{m.value=c,p.value=r,M(v)});function v(){const r=o.newOriginalNumber,c=o.oldOriginalNumber;c===void 0||r===void 0||(r>c?_("up"):c>r&&_("down"))}function _(r){d.value=r,i.value=!1,M(()=>{var c;(c=h.value)===null||c===void 0||c.offsetWidth,i.value=!0})}return()=>{const{clsPrefix:r}=o;return g("span",{ref:h,class:`${r}-base-slot-machine-number`},m.value!==null?g("span",{class:[`${r}-base-slot-machine-old-number ${r}-base-slot-machine-old-number--top`,s.value]},m.value):null,g("span",{class:[`${r}-base-slot-machine-current-number`,w.value]},g("span",{ref:"numberWrapper",class:[`${r}-base-slot-machine-current-number__inner`,typeof o.value!="number"&&`${r}-base-slot-machine-current-number__inner--not-number`]},p.value)),m.value!==null?g("span",{class:[`${r}-base-slot-machine-old-number ${r}-base-slot-machine-old-number--bottom`,s.value]},m.value):null)}}}),{cubicBezierEaseOut:U}=ne;function Ze({duration:o=".2s"}={}){return[y("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${o} ${U},
 max-width ${o} ${U},
 transform ${o} ${U}
