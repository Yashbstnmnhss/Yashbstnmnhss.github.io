...
<template>
    <NSpace vertical>
        ...
        <NCard title="广义相遇论">
            <s>摘自《圣馒经》第二章第三节</s>
            <NBlockquote @copy="achiever.achieve('let_more_people_know_this')" id="text">
                网络上的感情不要带到现实里
                <br />
                绝望是来自过去的
                <br />
